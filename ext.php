...
namespace david63\resetpostcount;
	...
	public function is_enableable()
 	{
		...
		if (!$is_enableable)
		{
			...
			{
				$this->container->get('language')->add_lang('ext_enable_error', 'david63/resetpostcount');
			}
			else
			{
				$this->container->get('user')->add_lang_ext('david63/resetpostcount', 'ext_enable_error');
			}
		}
